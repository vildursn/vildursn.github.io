...
export const publications: Publication[] = [
  {
    ...
    authors: ['Dina Svendsen Solskinnsbakk', 'Sigurd Almli Hanssen', 'Harald Lykke Joakimsen', 'Vilde B Gjørum', 'Elisabeth Wetzer', 'Kristoffer Knutsen Wickstrøm'],
  ...
  },
  {
    ...
    authors: ['Vilde B Gjørum', 'Inga Strømke', 'Jakob Løver', 'Timothy Miller', 'Anastasios M Lekkas'],
  ...
  },
  {
    ...
    authors: ['Akhil Anand', 'Katrine Seel', 'Vilde Gjørum', 'Anne Håkansson', 'Haakon Robinson', 'Aya Saad'],
